...
public class Frag_Fourth_Story8_2 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frag_fourth8_2);

        ImageView f8_2 = findViewById(R.id.f8_2);
        Animation anima = AnimationUtils.loadAnimation(getApplicationContext(), R.anim.alpha);
        f8_2.startAnimation(anima);

        mp_four = MediaPlayer.create(getApplicationContext(),R.raw.sad);
